...
/* 
total: cantidad total de números en el stack A.
Determinar el tamaño de cada chunk según la cantidad total de elementos

1. total ≤ 100
	Si hay 100 números o menos, devolvemos 20.
	Esto significa:
...
while (c * chunk_size < total)
	...
	c * chunk_size es la posición inicial del chunk.
